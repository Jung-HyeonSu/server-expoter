...
#               + pre_commit_ticket_consistency (cold-start 6 절 — cycle 2026-05-06 advisory / cycle 2026-05-11 BLOCKING 격상 Phase 7)
...
echo "  TICKET_CONSISTENCY_SKIP=1     — pre_commit_ticket_consistency skip (cold-start 6 절, BLOCKING cycle 2026-05-11)"
