...
**커버리지 (30/30)**: 모든 Redfish adapter 가 credentials 블록 보유. cycle 2026-05-11 M-A5 결과 9 vendor 모두 primary infraops/__REDACTED__ + recovery vendor 공장 기본 (rule 27 R6 / `docs/operate/05-vault.md`).
