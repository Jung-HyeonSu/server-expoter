# hpe_emulator_dl325_gen10plus_fc — 에뮬레이터 캡처 fixture
...
- mockup: `DL325_Gen10Plus_FC`
- captured: 2026-06-08
- manager_fw(감지): `iLO 5 v2.46`
- vendor(감지): `hpe`
- status(감지): `success`
...
에뮬레이터를 호스트 443 에 `MOCKUP_FOLDER=DL325_Gen10Plus_FC` 로 띄운 뒤:

```
python tests/integration/capture_emulator.py --mockup DL325_Gen10Plus_FC --captured <YYYY-MM-DD>
```
