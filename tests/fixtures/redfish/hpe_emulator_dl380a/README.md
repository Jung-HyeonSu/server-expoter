# hpe_emulator_dl380a — 에뮬레이터 캡처 fixture
...
에뮬레이터를 호스트 443 에 `MOCKUP_FOLDER=DL380a` 로 띄운 뒤:

```
python tests/integration/capture_emulator.py --mockup DL380a --captured <YYYY-MM-DD>
```
