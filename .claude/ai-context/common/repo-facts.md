...
| Schema | `schema/` | sections.yml (11), field_dictionary.yml (47 Must / 81 Nice / 6 Skip = 134), baseline_v1/ (9 baseline: redfish 5 + esxi/ubuntu/windows + rhel810_raw_fallback) |
