...
| Redfish gather | `redfish-gather/` | site.yml (1-Play: precheck → detect → adapter → collect → normalize), library/redfish_gather.py (약 3,430줄) |
...
| Schema | `schema/` | sections.yml (10), field_dictionary.yml (39 Must / 29 Nice / 6 Skip = 74), baseline_v1/ (9 baseline: redfish 5 + esxi/ubuntu/windows + rhel810_raw_fallback) |
