...
- agent: `code-reviewer`, `adapter-boundary-reviewer`, `vendor-boundary-guardian`, `schema-reviewer`, `naming-consistency-reviewer`, `integration-impact-reviewer` (cycle-011: security-reviewer 제거)
