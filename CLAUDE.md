...
[6] 테스트 (tests/fixtures 398개 [실장비 380 + HPE 에뮬레이터 15 + DMTF 표준 목업 3] + 9 baseline + test_*.py 57파일/526 함수 [e2e_browser 2 포함] — 2026-06-09 재실측, +5 robustness 파일: mutation 하네스/multi_node/skeleton-sync/precheck/merge_fragment)
